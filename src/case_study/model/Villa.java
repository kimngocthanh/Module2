...
public class Villa extends Facility {
    ...
    public Villa(String idService, String nameService, double area, double rentalCosts, int quantity, String rentalType, String roomStandard, double areaSwimmingPool, int floor) {
